...
app.use(cors({
    origin: function(ctx) {
        ...
        if (ENV === 'development') {
            ...
            let whiteArray = [
                'http://ly.admin.com', 'https://ly.admin.com',
                'http://ly.website.com', 'https://ly.website.com',
                'http://ly.amwares.com', 'https://ly.amwares.com',
                'http://admin.amwares.com', 'http://admin.amwares.com'
            ];
